...
@dataclass
class RunArguments:
    model_name: str = field(default="bert-base-uncased", metadata={"help": "the name of the pretrained model"})
...
# setup wandb
wandb.login()
wandb.api_key = "fee5e2bbf85895e6cff585fa55c74a0349552d96"
...
model = AutoModelForSequenceClassification.from_pretrained(run_args.model_name, config=config)
